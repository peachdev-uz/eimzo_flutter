Pod::Spec.new do |s|
  ...
  # 2.1.1 faqat Android tuzatishi. iOS binari 2.1.0 da qoladi — unda ommaviy
  # API EImzoView, EImzoConfig va SignResult gacha qisqartirilgan.
  EIMZO_SDK_VERSION = '2.1.0'
